...
export const Neutral: React.FC<FormUrls> = ({ neutral = defaultUrl }) => {
  ...
  return (
    <div style={{ padding: 20 }}>
      <article style={{ maxWidth: 720, margin: "0 auto", background: "#fff", borderRadius: 10, padding: 32 }}>
        <h2 style={{ margin: 0, color: "#222", fontSize: 28 }}>Thanks for keeping us balanced.</h2>
        <p style={{ color: "#666", marginTop: 14 }}>Your feedback helps us understand what to keep doing and what to improve.</p>

        <div style={{ display: "flex", gap: 24, justifyContent: "center", marginTop: 28 }}>
          <a href={neutral} aria-label="Neutral" onClick={handleNavigate(neutral)} style={{ fontSize: 48 }}>
            🙂
          </a>
        </div>
