      ...
      <div className="w-full max-w-sm rounded-md border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <input
            ...
            className={`w-full rounded-md border px-4 py-3 text-center text-base font-medium tracking-wide text-slate-900 outline-none transition focus:ring-2 focus:ring-slate-900/20 ${
              status === "invalid"
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-md bg-slate-900 px-4 py-3 text-sm font-semibold text-white transition hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-40"
          >
            {status === "checking" ? (
              <>
        ...
        {status === "valid" && (
          <div className="mt-4 flex items-center gap-2 rounded-md bg-emerald-50 px-4 py-3 text-sm font-medium text-emerald-700">
        ...
        {status === "invalid" && (
          <div className="mt-4 flex items-center gap-2 rounded-md bg-red-50 px-4 py-3 text-sm font-medium text-red-700">
